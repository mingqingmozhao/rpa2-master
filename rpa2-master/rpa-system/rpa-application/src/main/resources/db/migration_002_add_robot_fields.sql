...
-- 数据迁移：将旧的 robot_type 字段值迁移到新字段（如果有数据）
-- UPDATE robot_info SET robot_type_new = robot_type WHERE robot_type IS NOT NULL;

-- 可选：删除旧的 robot_type 字段（如果需要）
-- ALTER TABLE robot_info DROP COLUMN robot_type;
